...
const Reserve = () => {
  ...
  let totalBill = data.cheapestPrice * count * dateCount;
  
  // console.log("totalBill", totalBill);
  // console.log(new Date(dateFrom));
  // console.log(new Date(dateTo));
  // console.log("dateCount", dateCount);
  // console.log(fullname, email, phone, identity);
  ...
  fetch("http://localhost:5000/reserve", requestOptions)
    ...
    .then((result) => {console.log(result)
      // const data = JSON.parse(result);
      // const dataRoom = JSON.parse(data.room);
      // console.log("result", JSON.parse(result), JSON.parse(data.room), dataRoom[1])
    })
    .catch((error) => console.log("error", error));
  }
