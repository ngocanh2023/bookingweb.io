    ...
    <div>
      ...
      <div className="hotelContainer">
        ...
        <div className="hotelWrapper">
          <button className="bookNow" onClick={()=>{navigate(`/reserve/${data._id}`)}}>Reserve or Book Now!</button>
          ...
          <div className="hotelDetails">
            ...
            <div className="hotelDetailsPrice">
              ...
              <h2>
                <b>${9 * data.cheapestPrice}</b> (9 nights)
              </h2>
              <button onClick={()=>{navigate(`/reserve/${data._id}`)}}>Reserve or Book Now!</button>
            </div>
          </div>
        </div>
        <MailList />
