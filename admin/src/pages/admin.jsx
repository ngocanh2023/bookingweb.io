...
const Admin = () => {
  ...
  return (
    <div>
              ...
              <div className="transactionInfo">
                ...
                <div className="countBtn">
                  ...
                  <div className="countNo">
                    ...
                    <div className="countTotal">{countPage - 1}</div>
                  </div>
      ...
      </div>):(<div className="loginCon">Please login first <div className="loginBtn" onClick={() =>{window.location.replace("http://localhost:3000/login")}}><button>Login</button></div></div>)}
    </div>
  );
};
